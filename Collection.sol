...
//  mapping(address => bool) public whitelisted;
 event NftMarketUpdated(address indexed nftMarket);
   ...
   * @notice Returns the address of the Foundation NFTMarket contract.
   */
  function getNftMarket() internal view returns (address) {
    return address(nftMarket);
  }
   ...
   */
   ...
   modifier onlyCollectionCreator() {
       require(msg.sender==collectionCreator,"Address is not the collection creator");
       _;
   }
   ...
   */
  function mint(string memory tokenIPFSPath) public onlyCollectionCreator returns (uint256 tokenId) {
    tokenId = nextTokenId++;
   ...
   */
  function mintAndApproveMarket(string memory tokenIPFSPath) public onlyCollectionCreator returns (uint256 tokenId) {
  ...
  NFT721Mint
{
   ...
   */
   function initialize(
    ...
    uint256 supply, address collectionCreator
  ) public initializer {
   ...
   */
  function adminUpdateConfig(address _nftMarket, string memory baseURI) public {
